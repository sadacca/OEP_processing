...
% Auto-generated by MATLAB on 2016/03/24 17:24:26
...
eventstamps = (cellfun(@(x) x,eventdata(kindex(ratindex)+1:lindex(ratindex)-1,3:7)));
eventtimes = (cellfun(@(x) x,eventdata(lindex(ratindex)+1:lindex(ratindex)+lindex(ratindex)-kindex(ratindex)-1,3:7)));
